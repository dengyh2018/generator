...
public class InnerClass extends JavaElement {
    ...
    public String getFormattedContent(int indentLevel) {
        ...
        String className = getType().getShortName();

        //为base结尾的bean继承"basevo"
        sb.append(className); //.append(className.endsWith("Base") ? " extends BaseVO " : "");
        ...
        while (fldIter.hasNext()) {
            ...
            if (className.endsWith("Base")) {
                ...
                if ("createdBy".equalsIgnoreCase(fieldName) || "creationDate".equalsIgnoreCase(fieldName)
                        || "lastUpdatedBy".equalsIgnoreCase(fieldName) || "lastUpdateDate".equalsIgnoreCase(fieldName)) {
                    continue;
                }
            }
        ...
        while (mtdIter.hasNext()) {
            ...
            if (className.endsWith("Base")) {
                ...
                if ("getcreatedBy".equalsIgnoreCase(methodName) || "getcreationDate".equalsIgnoreCase(methodName)
                        || "getlastUpdatedBy".equalsIgnoreCase(methodName) || "getlastUpdateDate".equalsIgnoreCase(methodName)
                        || "setcreatedBy".equalsIgnoreCase(methodName) || "setcreationDate".equalsIgnoreCase(methodName)
                        || "setlastUpdatedBy".equalsIgnoreCase(methodName) || "setlastUpdateDate".equalsIgnoreCase(methodName)) {
                    continue;
                }
            }
