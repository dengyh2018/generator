...
import org.mybatis.generator.internal.db.TableSchemaHelp;
...
public class Context extends PropertyHolder {
    ...
    /**
     * This method does a simple validate, it makes sure that all required fields have been filled in. It does not do any more complex operations such
     * as validating that database tables exist or validating that named columns exist
     */
     ...
     * @param fullyQualifiedTableNames a set of table names to generate. The elements of the set must be Strings that exactly match what's specified in the configuration.
     *                                 For example, if table name = "foo" and schema = "bar", then the fully qualified table name is "foo.bar". If the Set is null or
     *                                 empty, then all tables in the configuration will be used for code generation.
    ...
    public void introspectTables(ProgressCallback callback, List<String> warnings, Set<String> fullyQualifiedTableNames)
        ...
        Map<String, String> tablesRemarks = new HashMap<String, String>();
