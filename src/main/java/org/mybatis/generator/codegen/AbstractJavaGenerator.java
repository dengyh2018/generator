...
public abstract class AbstractJavaGenerator extends AbstractGenerator {
    ...
    protected void addSerialInterface(TopLevelClass topLevelClass) {
        FullyQualifiedJavaType superClass2=new FullyQualifiedJavaType("java.io.Serializable");
        topLevelClass.getSuperInterfaceTypes().add(superClass2);
        topLevelClass.addImportedType(superClass2);
    }
    
    protected void addSerialField(TopLevelClass topLevelClass) {
        FullyQualifiedJavaType fqjt = new FullyQualifiedJavaType("java.lang.long");
        Field field = new Field();
        field.setVisibility(JavaVisibility.PRIVATE);
        field.setType(fqjt);
        ...
        field.setInitializationString(new Date().getTime()+"L");
    ...
    protected static String lowerCaseFirstChar(String input) {
