...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectByUniqueElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addSelectByUniqueElement(answer);
    ...
    protected void addSelectByUniqueElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateSelectByUnique()) {
            AbstractXmlElementGenerator elementGenerator = new SelectByUniqueElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
