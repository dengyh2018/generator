...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        commentGenerator.addJavaClassComment(interfaze, introspectedTable, ClassRemarkEnum.Dao基础接口);
        ...
        addSelectByUniqueKeyMethod(interfaze);
    ...
    private void addSelectByUniqueKeyMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateSelectByUnique()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new SelectByUniqueKeyMethodGenerator(false);
