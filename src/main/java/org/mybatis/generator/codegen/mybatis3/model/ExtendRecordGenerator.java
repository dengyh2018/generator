 ...
 *
 */
public class ExtendRecordGenerator extends AbstractJavaGenerator {

    public ExtendRecordGenerator() {
        super();
    }
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        FullyQualifiedJavaType type = new FullyQualifiedJavaType(introspectedTable.getExtendRecordType());

        TopLevelClass topLevelClass = new TopLevelClass(type);

        topLevelClass.setVisibility(JavaVisibility.PUBLIC);
        commentGenerator.addJavaFileComment(topLevelClass);
        commentGenerator.addJavaClassComment(topLevelClass, introspectedTable, ClassRemarkEnum.Bean扩展字段类);
